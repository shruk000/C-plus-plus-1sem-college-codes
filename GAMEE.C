...
//cordinates
gotoxy(53,7);printf("1,1");gotoxy(63,7);printf("1,2");gotoxy(73,7);printf("1,3");
gotoxy(53,11);printf("2,1");gotoxy(63,11);printf("2,2");gotoxy(73,11);printf("2,3");
gotoxy(53,15);printf("3,1");gotoxy(63,15);printf("3,2");gotoxy(73,15);printf("3,3");
